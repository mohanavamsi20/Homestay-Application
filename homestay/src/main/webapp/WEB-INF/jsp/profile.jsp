                ...
                <div class="comment-form-wrap pt-5">
                    <form action="#" class="p-5 bg-light">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${name}" class="form-control" id="name" disabled>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" value="${email}" class="form-control" id="email" disabled>
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input type="password" value="${password}" class="form-control" id="password" disabled>
                            <input type="checkbox" onclick="myFunction()">Show Password
                        </div>

                        <div class="form-group">
                            <label for="phone">Phone Number</label>
                            <input type="phone" value="${phone}" class="form-control" id="phone" disabled>
                        </div>
                        <a>For account deactivation please contact to site owner</a>
                    </form>
                </div>
            </div>
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="categories">
                        ...
                        <% String admin = (String) session.getAttribute("username");
                            if(admin == "admin"){%>
                        <li><a href="/users">All Users<span></span></a></li>
                        <li><a href="/bookings">All Bookings<span></span></a></li>
                        <li><a href="/rent">All Rented Houses <span></span></a></li>
                        <%}else{%>
